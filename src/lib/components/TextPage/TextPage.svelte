...
<div style="background-color: {bgColor ? '#860116' : 'unset'};" class="page container">
	<div class="text-content">
		<div class="bu-content bu-is-large">
			<div class="header-container">
				...
				<img class="header-stroke" src="images/{text_content.headerBrush}" alt="" />
			</div>
		</div>
		<div bind:this="{scrollContainer}" class="bu-content text-container">
			<div class="scroll-container-text">
				<img class="p-stroke" src="images/{text_content.pgBrush}" alt="" />
