...
<div class="card-wrapper">
	<div class="bg-image-container">
		<img class="bg-image" src="images/mobile/bg.jpg" alt="" />
	</div>
	<div id="home" class="logo-wrapper">
		<div class="logo-container">
			<img class="image-logo" src="images/mobile/mobile-logo.png" alt="" />
		</div>
	</div>
	<div id="quote" class="quote-container">
		<div class="quote-image-container">
			<img src="images/mobile/quotes.png" alt="" class="quote-image" />
		</div>
	</div>
